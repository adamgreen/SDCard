...
static const uint8_t g_Crc7Table[] = {
...
// Not making this "static const" so that the compiler places it in
// .data (RAM) instead of .text (FLASH) which improves read/write
// speeds by 6%.
uint16_t g_Crc16Table[256] = {
...
uint8_t crc7(const uint8_t* pData, size_t length)
{
...
uint16_t crc16(const uint8_t* pData, size_t length)
{
